        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                >
                    ...
                    <div class="m-4">
                        <Pagination :elements="categories"></Pagination>
                    </div>
                </div>
            </div>
        </section>
...
const openCategoryModal = (create = false, category = null) => {
...
const submitCategory = async () => {
    ...
    for (const [key, value] of Object.entries(categoryData.value)) {
        if (value !== null && value !== "") {
    ...
    try {
        const url = categoryData.value.id
            ? `/admin/categories/update/${categoryData.value.id}`
